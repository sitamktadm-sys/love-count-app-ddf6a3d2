...
const FinalCTASection = () => {
  return (
    <section className="py-16 md:py-24 bg-pink" aria-labelledby="final-cta-heading">
      <div className="container-narrow text-center">
        <h2 id="final-cta-heading" className="text-3xl md:text-4xl font-bold text-navy mb-4">
